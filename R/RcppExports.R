...
get_all_callbackids <- function() {
    .Call('_later_get_all_callbackids', PACKAGE = 'later')
}

reset_all_callbackids <- function() {
    invisible(.Call('_later_reset_all_callbackids', PACKAGE = 'later'))
}
