...
extern SEXP _later_setCurrentLoopXptr(SEXP);
extern SEXP _later_getCurrentLoopXptr();
...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"_later_setCurrentLoopXptr",  (DL_FUNC) &_later_setCurrentLoopXptr,  1},
  {"_later_getCurrentLoopXptr",  (DL_FUNC) &_later_getCurrentLoopXptr,  0},
