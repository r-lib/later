...
[`later::run_now()`](https://later.r-lib.org/reference/run_now.md).
...
[`later::later`](https://later.r-lib.org/reference/later.md) is
...
[`later::later_fd`](https://later.r-lib.org/reference/later_fd.md) is
also accessible from `later_api.h` and its prototype looks like this:
...
[`later_fd()`](https://later.r-lib.org/reference/later_fd.md) when
